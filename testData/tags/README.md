...
```go
import "github.com/peczenyj/gomarkdoc/testData/tags"
```
...
## func [Tagged](<https://github.com/peczenyj/gomarkdoc/blob/master/testData/tags/tagged.go#L7>)
...
## func [Untagged](<https://github.com/peczenyj/gomarkdoc/blob/master/testData/tags/untagged.go#L5>)
